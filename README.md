...
<h1 align = "center">student-origin-loan</h1>

## 项目演示地址：

- [🚀🚀🚀🚀 官网&文档地址 🚀🚀🚀🚀](http://www.vueadminwork.com)

- [🎉Vue Admin Work 演示地址（Vue2.x + Javascript + Element UI + Webpack）](http://qingqingxuan.gitee.io/student-origin-loan)
...
```shell
# 克隆项目
git clone -b master https://github.com/qingqingxuan/student-origin-loan.git
# 进入项目目录
